...
<?php include 'nav.php';?>
    ...
    <div class="highlight-phone" style="background-image:url(&quot;assets/img/3.png&quot;);height:370px;">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <div class="intro" style="background-color:rgba(255,255,255,0);">
                        <h2 style="color:rgb(255,255,255);background-color:rgba(255,255,255,0);">Highlight</h2>
                        <p style="color:rgb(255,255,255);background-color:rgba(255,255,255,0);">Nunc luctus in metus eget fringilla. Aliquam sed justo ligula. Vestibulum nibh erat, pellentesque ut laoreet vitae. Aliqua sed justo ligula.</p><a class="btn btn-primary" role="button" href="#" style="background-color:rgb(255,255,255);">Action Button</a></div>
                </div>
                <div class="col-sm-4">
                    <div class="d-none d-md-block iphone-mockup"><img src="assets/img/iphone.svg" class="device">
                        <div class="screen" style="background-image:url(&quot;karl-kohler-542337-unsplash (1).jpg&quot;);"></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="article-list">
        <div class="container">
            ...
            <div class="row articles">
                <div class="col-sm-6 col-md-4 item"><a href="top_event.php"><img class="img-fluid" src="assets/img/campbell-boulanger-348386-unsplash (1) (1).jpg"></a>
                    <h3 class="name">Top Event</h3>
                ...
                <div
                    class="col-sm-6 col-md-4 item"><a href="new_event.php"><img class="img-fluid" src="assets/img/campbell-boulanger-348386-unsplash (1) (1).jpg"></a>
                    <h3 class="name">New event</h3>
                    <p class="description">Aenean tortor est, vulputate quis leo in, vehicula rhoncus lacus. Praesent aliquam in tellus eu gravida. Aliquam varius finibus est, interdum justo suscipit id.</p><a href="#" class="action"><i class="fa fa-arrow-circle-right"></i></a></div>
            <div
                class="col-sm-6 col-md-4 item"><a href="upcoming_event.php"><img class="img-fluid" src="assets/img/campbell-boulanger-348386-unsplash (1) (1).jpg"></a>
                <h3 class="name">Upcoming Event</h3>
                <p class="description">Aenean tortor est, vulputate quis leo in, vehicula rhoncus lacus. Praesent aliquam in tellus eu gravida. Aliquam varius finibus est, interdum justo suscipit id.</p><a href="#" class="action"><i class="fa fa-arrow-circle-right"></i></a></div>
    </div>
    </div>
    </div>
    ...
    <div class="testimonials-clean">
        <div class="container">
            <div class="intro">
                <h2 class="text-center">What Client Say</h2>
            </div>
     ...
     <div class="container" style="margin-left:120px;" align="center">
  <h2 class="text-center" style="margin-left:-110px;"><b>Blogs<b></h2>
