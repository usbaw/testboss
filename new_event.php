...
include 'con_nect.php';
	$query = mysqli_query($run, "SELECT * FROM events");
	while($row=mysqli_fetch_array($query)) {
	echo'
	<div class=" col-xl-3 col-sm-12 col-md-6 col-lg-6 mt-4">
	<div class="card">
	<img class="card-img-top" src="'.$row["imglocation"].'">
	<div class="card-block">
	<h4 class="card-title mt-3">'.$row["title"].'</h4>
	<div class="meta"><a href="#">'.$row["date"].' '.$row["time"].'</a></div>
	<div class="meta"><a href="#">'.$row["location"].'</a></div>
	<div class="card-text">'.$row["details"].'</div></div>
	<div class="card-footer">
	<a href="open_event.php?id='.$row["id"].'" class="btn btn-secondary  btn-sm">Show</a></div>
	</div>
	</div>
	';
	}
