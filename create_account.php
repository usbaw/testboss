...
<body>
    <div class="register-photo">
        ...
        <div class="form-container">
            <div class="image-holder" style="background-image:url(&quot;assets/img/4.png&quot;);"></div>
            <form method="post">
                <h2 class="text-center"><strong>Create</strong> an account.</h2>
                <div class="form-group"><input class="form-control" type="text" name="firstname" placeholder="First Name"></div>
                <div class="form-group"><input class="form-control" type="text" name="middlename" placeholder="Middle Name"></div>
                <div class="form-group"><input class="form-control" type="text" name="lastname" placeholder="Last Name"></div>
                <div class="form-group"><?php include'country.txt';?></div>
                <div class="form-group"><input class="form-control" type="text" name="bdate" placeholder="Birthdate: yyyy/mm/dd"></div>
                <div class="form-group"><select name="sex" class="text form-control"><option value="Male">Male</option><option value="Female">Female</option></select></div>
                <div class="form-group"><input class="form-control" type="text" name="cardetails" placeholder="Car Details"></div>
                ...
                <div class="form-group"><button class="btn btn-primary btn-block" type="submit" name="signup">Sign Up</button></div><a href="index.php" class="already">You already have an account? Login here.</a>
				<!--For Including the Code of SignUP-->
				<?php include'create_account_code.php';?>
				</form>
        </div>
    </div>
