...
<body style="background-image:url(&quot;matt-henry-59403-unsplash (1).jpg&quot;);">
    ...
    <div class="highlight-phone" style="background-image:url(&quot;assets/img/3.png&quot;);height:365px;">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <div class="intro">
                        <h2 style="color:rgb(255,255,255);">New Event</h2>
                        <p style="color:rgb(254,254,254);">Nunc luctus in metus eget fringilla. Aliquam sed justo ligula. Vestibulum nibh erat, pellentesque ut laoreet vitae. Aliqua sed justo ligula.</p><a class="btn btn-primary" role="button" href="#" style="background-color:rgb(255,255,255);">Action Button</a></div>
                </div>
                <div class="col-sm-4">
    ...
    <div class="row product-list">
        <div class="col-sm-6 col-md-4 product-item">
            <div class="product-container">
                <div class="row">
                    <div class="col-md-12"><a href="#" class="product-image"><img src="assets/img/campbell-boulanger-348386-unsplash (1) (1).jpg"></a></div>
                </div>
                <div class="row">
                    <div class="col-8">
                        <h2><a href="event_description.php">Event 1</a></h2>
                    </div>
                    <div class="col-4"><a href="event_description.php" class="small-text">compare </a></div>
                </div>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="row">
                            <div class="col-6"><button class="btn btn-light" type="button">Register</button></div>
                            <div class="col-6">
        ...
        <div class="col-sm-6 col-md-4 product-item">
            <div class="product-container">
                <div class="row">
                    <div class="col-md-12"><a href="event_description.php" class="product-image"><img src="assets/img/campbell-boulanger-348386-unsplash (1) (1).jpg"></a></div>
                </div>
                <div class="row">
                    <div class="col-8">
                        <h2><a href="event_description.php">Event 2</a></h2>
                    </div>
                    <div class="col-4"><a href="event_description.php" class="small-text">compare </a></div>
                </div>
                <div class="product-rating"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star-half"></i><a href="#" class="small-text">82 reviews</a></div>
        ...
        <div class="col-sm-6 col-md-4 product-item">
            <div class="product-container">
                ...
                <div class="row">
                    <div class="col-8">
                        <h2><a href="event_description.php">Event 3</a></h2>
                    </div>
                    <div class="col-4"><a href="event_description.php" class="small-text">compare </a></div>
                </div>
                <div class="product-rating"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star-half"></i><a href="#" class="small-text">82 reviews</a></div>
